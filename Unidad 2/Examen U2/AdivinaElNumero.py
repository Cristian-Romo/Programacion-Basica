...
Se manda llamar la funcion de la libreria para generar un numero random y establces los limites
2. ¿Qué tipo es la variable intentos?
Es una constante a la que se le esta asignando un valor ya establecido.
3. ¿Qué estamos haciendo en la línea 1?
Se esta mandando a llamar a una libreria llamada random
4. ¿Mencione los operadores que se utilizan en el código?
=,+,==,>
5. ¿Qué hace la palabra intentos que está entre corchetes?
Imprime la cantidada de intentos que hiciste para adivinar el numero secreto
